        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-4">
                Send notices to: <a href="mailto:help@watchmovora.com" className="text-primary hover:underline">help@watchmovora.com</a>
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-3 p-4 rounded-xl bg-white/5 border border-white/10 space-y-1">
                ...
                <p><span className="text-foreground font-medium">Email:</span> <a href="mailto:help@watchmovora.com" className="text-primary hover:underline">help@watchmovora.com</a></p>
