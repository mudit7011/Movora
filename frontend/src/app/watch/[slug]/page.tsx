...
export default async function WatchPage({ params }: Props) {
  ...
  const sources: Source[] = [
    ...
    { serverName: 'Server 4', url: `https://nhdapi.com/embed/movie/${id}?autoplay=true&lang=Hindi&primarycolor=06D6E0&secondarycolor=0891B2&iconcolor=FFFFFF&glasscolor=000000&glassopacity=80&glassblur=20&fontcolor=FFFFFF&subtitle=Off`, type: 'iframe', quality: 'HD', isWorking: true },
  ]
