...
export default async function WatchPage({ params }: Props) {
  ...
  const sources: Source[] = [
    ...
    { serverName: 'Server 4', url: `https://vidfast.pro/movie/${id}?autoPlay=true&theme=06D6E0&hideServer=true&chromecast=true&title=false&poster=false`, type: 'iframe', quality: 'HD', isWorking: true },
