...
export default async function WatchPage({ params }: Props) {
  ...
  const sources: Source[] = [
    ...
    { serverName: 'Server 2', url: `https://nxsha.space/embed/movie/${id}?lang=hi`, type: 'iframe', quality: 'HD', isWorking: true },
    // Trimmed for a cleaner UX (Premium + Videasy + nxsha). Uncomment if a title only works on these:
    // { serverName: 'Server 3', url: `https://vidfast.pro/movie/${id}?autoPlay=true&theme=06D6E0&hideServer=true&chromecast=true&title=false&poster=false`, type: 'iframe', quality: 'HD', isWorking: true },
    // { serverName: 'Server 4', url: `https://embedmaster.link/fljq7ku6ysokw3og/movie/${id}`, type: 'iframe', quality: 'HD', isWorking: true },
    // { serverName: 'Server 5', url: `https://vidlink.pro/movie/${id}?primaryColor=06D6E0&autoplay=true`, type: 'iframe', quality: 'HD', isWorking: true },
