  ...
  try {
    ...
    await Movie.create({
      ...
      sources: [
        ...
        { serverName: 'Server 4', url: `https://streamvaultsrc.click/embed/movie/${id}?autoplay=true&muted=true&color=06D6E0`,              type: 'iframe', quality: 'HD', isWorking: true },
      ],
      streamVerified: true,
  ...
  try {
    ...
    await Movie.create({
      ...
      sources: [
        ...
        { serverName: 'Server 4', url: `https://streamvaultsrc.click/embed/tv/${id}/1/1?autoplay=true&muted=true&color=06D6E0`,                                     type: 'iframe', quality: 'HD', isWorking: true },
      ],
      streamVerified: true,
      scrapedFrom: 'realtime',
